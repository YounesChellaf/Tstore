                    ...
                    <div class="ckeckout-left-sidebar">
                        ...
                        <div class="our-payment-sestem">
                            ...
                            <ul class="payment-menu">
                                <li><a href="#"><img src="{{asset('assets/img/payment/1.jpg')}}" alt="payment-img"></a></li>
                                <li><a href="#"><img src="{{asset('assets/img/payment/2.jpg')}}" alt="payment-img"></a></li>
                                <li><a href="#"><img src="{{asset('assets/img/payment/3.jpg')}}" alt="payment-img"></a></li>
                                <li><a href="#"><img src="{{asset('assets/img/payment/4.jpg')}}" alt="payment-img"></a></li>
                                <li><a href="#"><img src="{{asset('assets/img/payment/5.jpg')}}" alt="payment-img"></a></li>
                            </ul>
